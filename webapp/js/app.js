...
function RecognitionPage() {
  const page = el("div", { class: "card pad" }, [
    el("div", { class: "row2" }, [
      ...
      el("div", { class: "card pad-lg" }, [
        el("div", { style: "font-weight:1000;color:var(--navy);font-size:18px;" }, "Historial"),
        el("div", { class: "smallHelp", style: "margin-top:6px;" }, "Tus análisis recientes."),
        el("div", { class: "hr" }),
        el("div", { class: "chatMsgs", id: "recMsgs", style: "max-height:520px;" })
      ])
    ])
  ]);
      ...
      el("div", { class: "row2" }, [
        el("div", {}, [
          ...
          el("div", { class: "smallHelp" }, [
            ...
            "Usando esta aplicación aceptas nuestros ", el("a", { href: "/terms.html", target: "_blank", rel: "noopener noreferrer", style: "color:var(--link);font-weight:900;text-decoration:none;" }, "Términos y Condiciones")
          ])
        ]),
        el("div", {}, [
